...
if(isset($_POST['submit']))           //if upload btn is pressed
{
    ...
    if(!preg_match('/^[a-zA-Z\s]+$/', $_POST['d_name']) || !preg_match('/^[a-zA-Z\s]+$/', $_POST['res_name'])) {
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" class="form-control form-control-danger" placeholder="description" required>
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
