...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	if(!preg_match('/^[a-zA-Z\s]+$/', $_POST['res_name']) || !preg_match('/^[a-zA-Z\s]+$/', $_POST['address'])) {
...
<?php include 'header.php'; ?>
  <?php include 'nav.php' ?>
       <?php include 'dashboardlayout.php' ?>
        <!-- End header header -->
        <!-- Left Sidebar  -->
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0  text-success">Update Restaurant</h4>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" value="<?php echo $row['title'];  ?>" class="form-control" placeholder="John doe" required>
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="email" value="<?php echo $row['email'];  ?>"class="form-control form-control-danger" placeholder="example@gmail.com" required>
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="09335054257" required>
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" type="text" style="height:100px;" class="form-control" required> <?php echo $row['address']; ?> </textarea>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <?php else: ?>
                                         <h2 class ="text-danger"> <em>NO DATA FOUND !</h2>
                                      <?php endif; ?>
