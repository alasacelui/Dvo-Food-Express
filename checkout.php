                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                                <li class="nav-item"> <a class="nav-link active" href="#">About us <span class="sr-only"></span></a> </li>
                            ...
                            if(empty($_SESSION["user_id"]))
                            ...
                            else
                                {
                                        ...
                                        echo  '<li class="nav-item"><a href="logout.php" class="nav-link active">Sign out</a> </li>';
                                }
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="paypal" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Paypal (Temporary not available) <img src="images/paypal.jpg" alt="" width="90"></span> </label>
                                            </li>
                                        </ul>
