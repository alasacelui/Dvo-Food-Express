<?php include('header.php');?>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/burger1.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & Take-Out </h1>
                    <h5 class="font-white space-xs">You choose , We Deliver !</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='restaurants.php'" type="button" class="btn btn-lg" style="color:#ffff;background-color:orange;border:none">Search food</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from over 25 delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="featured-restaurants" data-aos="fade-up">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		...
																		<div class="mins"><i class="fa fa-motorcycle"></i> 25 min</div>
        ...
        <iframe data-aos="fade-up" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.5906464055356!2d125.59108931526096!3d7.057290718684302!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f9729e9eeb10eb%3A0x3b44d14b549ea85f!2sPhilippine%20Women&#39;s%20College%20of%20Davao!5e0!3m2!1sen!2sph!4v1605077891877!5m2!1sen!2sph" width="2000" height="500" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
        <!-- start: FOOTER -->
