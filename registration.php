...
{     
   ...
   if(!preg_match('/^[a-zA-Z\s]+$/', $_POST['firstname'])|| !preg_match('/^[a-zA-Z\s]+$/',$_POST['lastname'])) {
      $message = "Firstname or Lastname must be letters only !";
   }
   ...
   //    }
	...
	mysqli_query($db, $mql);
		$success = "Account Created successfully! <p>You will be redirected in <span id='counter'>5</span> second(s).</p>
		 ...
		 header("Location:login.php"); // redireted once inserted success
    }
	}
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required> <small id="emailHelp" class="form-text text-muted">We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Phone number</label>
                                       <input class="form-control" type="number" name="phone" id="example-tel-input-3" placeholder="Phone"> <small class="form-text text-muted" required>We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
